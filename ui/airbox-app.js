...
/* ---- dev-console easter egg ---- prints on load. Chromium renders the goat
   logo (inline base64 CSS background); other browsers just
   show the wordmark + note. */
try {
  console.log('%c ','font-size:1px;line-height:0;padding:78px 60px;background:url("data:image/png;base64,") no-repeat center;background-size:contain;');
  console.log('%c\n'
    +'    _    _      ____\n'
    +'   / \\  (_)_ __| __ )  _____  __\n'
    +'  / _ \\ | | \'__|  _ \\ / _ \\ \\/ /\n'
  ...
  console.log('%cHey Cesar — you found the console.\n'
