...
// CHART_SAMPLES (12 h); the CSV export covers the whole 7 days.
#define HISTORY_SAMPLES          2016        // 7 days @ 5 min
#define HISTORY_INTERVAL_MS      300000UL    // 5 minutes
#define CHART_SAMPLES            144         // dashboard chart window: last 12 h (full day/night cycle)
